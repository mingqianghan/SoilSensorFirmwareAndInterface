...
{
	// GpioSetIrq( RADIO_DIO_1_GPIO_Port, RADIO_DIO_1_Pin, IRQ_HIGH_PRIORITY, irqHandlers[0] );
	// GpioSetIrq( GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, uint32_t prio,  GpioIrqHandler *irqHandler )
...
void SX126xWakeup( void )
{
    ...
    Sx126x_SpiInOut( &SX126x.Spi, RADIO_GET_STATUS );
...
{
	return HAL_GPIO_ReadPin(RADIO_DIO_1_GPIO_Port,RADIO_DIO_1_Pin);
